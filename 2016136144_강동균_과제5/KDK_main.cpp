...
int main(int argc, char *argv[])
{
	...
	otsu_thresholding(buffer, dst, number_of_pixels, cols, rows);

	//Iterative_thresholding(buffer, dst, number_of_pixels, cols, rows);

	//closing(buffer, dst, number_of_pixels, cols, rows);

	//opening(buffer, dst, number_of_pixels, cols, rows);

	//erosion(buffer, dst, number_of_pixels, cols, rows);
	
	//dilation(buffer, dst, number_of_pixels, cols, rows);
